...
public abstract class MicroEmulatorActivity extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        emulatorContext = new EmulatorContext() {
            ...
            private final DeviceDisplay deviceDisplay = new AndroidDeviceDisplay(MicroEmulatorActivity.this, this, 200, 200);

            private final FontManager fontManager = new AndroidFontManager(getResources().getDisplayMetrics());
